...
public class GarysGame3 implements EntryPoint {
	...
	private final HTML jqueryContainer = new HTML("<a href=\"jquery/jQuery_demo.html\">JQUERY EXAMPLE</a>");
	...
	private final BackGroundColorList backGroundColorList = new BackGroundColorList();
	/**
...
//		final Image sunset = new Image("images/Sunset.jpg");
        ...
        RootPanel.get("jqueryContainer").add(jqueryContainer);
		...
		RootPanel.get("backGroundColorListContainer").add(backGroundColorList.getColorList());
